...
@section('title','Replyform')
@section('content')
    <div id="breadcrumb"> <a href="{{route('admin_home')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="{{route('replyindex')}}">Reply Feedback</a> <a href="{{route('replyform','$replyid->id')}}" class="current">Reply Form</a> </div>
    <div class="container-fluid">
        <div class="widget-box">
            ...
            <div class="widget-content nopadding">
                <form action="{{route('replied','$replyid->id')}}" method="post" class="form-horizontal">
