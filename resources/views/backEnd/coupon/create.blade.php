...
@section('content')
    <div id="breadcrumb"> <a href="{{url('/farmerpanel')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="{{route('coupon.index')}}">Coupons</a> <a href="{{route('coupon.create')}}" class="current">Add New Coupon</a> </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls{{$errors->has('coupon_code')?' has-error':''}}">
                            <input type="text" name="coupon_code" id="coupon_code" class="form-control" value="{{old('coupon_code')}}"
                                   title="" required="required" minlength="1" maxlength="15" style="width: 400px;">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls{{$errors->has('expiry_date')?' has-error':''}}">
                            <div class="input-prepend">
                                <div  data-date="2019-04-01" class="input-append date datepicker">
