...
@section('content')
    <div id="breadcrumb"> <a href="{{url('/farmerpanel')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="{{route('product.index')}}">Products</a> <a href="#" class="current">Add Attribute</a> </div>
                            ...
                            <ul class="recent-posts">
                                <li>
                                    ...
                                    <div class="article-post">
                                        <span class="user-info">Product Code : <b>{{$product->id}}</b></span>
                                    </div>
                                </li>
                                <li>
                                    <form action="{{route('product_attr.store')}}" method="post" role="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="quality" value="{{old('quality')}}" id="sku" placeholder="Quality" required>
                                            <input type="text" class="form-control" name="weight" value="{{old('weight')}}" id="size" placeholder="Weight" required>
                    ...
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            <form action="{{route('product_attr.update',$product->id)}}" method="post" role="form">
                                ...
                                <tr>
                                    <td class="taskDesc">
                                        <input type="text" name="quality[]" id="sku" class="form-control" value="{{$attribute->quality}}" required="required" style="width: 75px;">
                                    </td>
                                    <td class="taskStatus">
                                        <input type="text" name="weight[]" id="size" class="form-control" value="{{$attribute->weight}}" required="required" style="width: 75px;">
                                    </td>
