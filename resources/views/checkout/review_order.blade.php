    ...
    <div class="container">
        ...
        <div class="row">
            <form action="{{url('/submit-order')}}" method="post" class="form-horizontal">
                ...
                <input type="hidden" name="product_name" value="{{$cart_data->product_name}}">
                <input type="hidden" name="quantity" value="{{$cart_data->quantity}}">
                <input type="hidden" name="products_id" value="{{$cart_data->products_id}}">
                @endforeach
                ...
                <div class="col-sm-12">
                    ...
                    <section id="cart_items">
                            ...
                            <table class="table table-condensed">
                                ...
                                @foreach($cart_datas as $cart_data)
                                    ...
                                    <td class="cart_description">
                                        ...
                                        <p>{{$cart_data->products_id}} | {{$cart_data->weight}}</p>
                                    </td>
                                    <td class="cart_price">
                                ...
                                <input type="hidden" name="farmer_id" value="{{$cart_data->farmerid}}">
                                @endforeach
                                <tr>
                                    <td colspan="4">&nbsp;</td>
                                    <td colspan="2">
                                        <table class="table table-condensed total-result">
                                            ...
                                            @else
                                                <tr>
                                                    <td>Total</td>
                                                    <td><span>NPR {{$total_price}}</span></td>
                                                </tr>
                                            @endif
                                        </table>
                                    </td>
                        ...
                        <span>
                            ...
                            <button type="submit" class="btn btn-primary {{$menu_active==6? ' active':''}}" style="float: right;">Order Now</button>
                        </div>
                    </section>
